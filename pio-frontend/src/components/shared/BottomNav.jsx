  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <button
        ...
        onClick={openModal}
        className="absolute bottom-6 bg-primary text-[#f5f5f5] rounded-full p-3 items-center"
      >
        <BiSolidDish size={30} />
      </button>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
        ...
        <button
          ...
          className="w-full bg-primary text-[#f5f5f5] rounded-lg py-3 mt-8 hover:bg-accent"
        >
          Create Order
        </button>
      </Modal>
